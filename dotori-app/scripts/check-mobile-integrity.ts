...
const CHECKS: IntegrityCheck[] = [
	...
	},
	{
		...
		file: "src/components/dotori/BottomTabBar.tsx",
		pattern: /DS_LAYOUT\.SAFE_AREA_TABBAR|safe-area-inset-bottom/,
		expect: true,
	},
	{
		name: "Facility contact sticky action uses safe-area",
		file: "src/components/dotori/facility/FacilityContactSection.tsx",
		pattern: /SAFE_AREA_FLOATING_ACTION|safe-area-inset-bottom/,
		expect: true,
	},
	{
		name: "App shell constrained to max-w-md",
		file: "src/app/(app)/layout.tsx",
		pattern: /DS_LAYOUT\.SAFE_AREA_BOTTOM|100svh|overflow-y-auto/,
		expect: true,
	},
	{
	...
	{
		name: "Toast stack uses safe-area anchor",
		file: "src/components/dotori/ToastProvider.tsx",
		pattern: /DS_LAYOUT\.SAFE_AREA_TOAST|safe-area-toast/,
		expect: true,
	},
];
