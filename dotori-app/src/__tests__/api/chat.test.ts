...
const {
  ...
  dbConnectMock,
  usageLogFindOneMock,
  usageLogFindOneAndUpdateMock,
  usageLogUpdateOneMock,
  usageLogCreateMock,
} = vi.hoisted(
  () => ({
    authMock: vi.fn(),
    ...
    usageLogUpdateOneMock: vi.fn(),
    usageLogCreateMock: vi.fn(),
  }),
)
...
vi.mock('@/models/UsageLog', () => ({
  default: {
    ...
    updateOne: usageLogUpdateOneMock,
    create: usageLogCreateMock,
  },
}))
...
beforeEach(async () => {
  ...
  usageLogUpdateOneMock.mockResolvedValue({ modifiedCount: 1, matchedCount: 1 })
  usageLogCreateMock.mockResolvedValue(undefined)
...
describe('POST /api/chat', () => {
  ...
  it('returns 403 when free user monthly quota is exhausted', async () => {
    ...
    usageLogUpdateOneMock.mockResolvedValue({ modifiedCount: 0, matchedCount: 1 })
