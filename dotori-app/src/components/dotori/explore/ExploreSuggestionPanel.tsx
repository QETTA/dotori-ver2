...
const chipBtnClass = cn(
	'inline-flex min-h-11 items-center gap-2 rounded-2xl border bg-white/90 px-3 py-2 text-label font-medium shadow-sm ring-1 ring-dotori-100/70 transition-colors duration-150',
						...
						<div className={'flex items-center gap-2'}>
							...
							>
								...
								<div className={'min-w-0'}>
									<div className={'flex items-center gap-2'}>
										<Text className={'text-h2 font-semibold text-dotori-900 dark:text-dotori-50'}>최근 검색</Text>
										<Badge color="forest" className={'text-label px-1.5 py-0.5'}>
											히스토리
										</Badge>
									</div>
									<Text className={'text-caption text-dotori-600 dark:text-dotori-300'}>최근 기록으로 빠르게 이동하세요</Text>
								</div>
							</div>
							<motion.div whileTap={{ scale: 0.96 }} transition={spring.chip}>
								<DsButton
									...
									className={'min-h-11 px-3 text-label font-semibold'}
								>
									전체 삭제
								</DsButton>
							</motion.div>
			...
			<motion.section initial="hidden" animate="show" variants={sectionVariants} className={sectionPanelClass}>
				<div className={'mb-3 flex items-center gap-2'}>
					...
					>
						...
						<div className={'min-w-0'}>
							<div className={'flex items-center gap-2'}>
								<Text className={'text-h2 font-semibold text-dotori-900 dark:text-dotori-50'}>인기 검색어</Text>
								<Badge color="forest" className={'text-label px-1.5 py-0.5'}>
									추천
								</Badge>
							</div>
							<Text className={'text-caption text-dotori-600 dark:text-dotori-300'}>요즘 많이 찾는 단어</Text>
						</div>
				</div>
				<motion.div initial="hidden" animate="show" variants={sectionVariants} className={'flex flex-wrap gap-2'}>
