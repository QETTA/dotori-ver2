...
export const DOTORI_STATE_TOKENS = {
  ...
  warmPaper:
    'pointer-events-none absolute inset-0 opacity-55 bg-gradient-to-b from-amber-50/30 via-forest-50/8 to-transparent',
...
export function EmptyState({
  ...
  const transferIcon = (
    <span
      className="inline-flex items-center gap-1.5 text-dotori-700 dark:text-dotori-100"
      aria-hidden="true"
    >
      {/* eslint-disable-next-line @next/next/no-img-element */}
