...
export function FacilityInsights({ facility }: FacilityInsightsProps) {
	...
	return (
		<section className="rounded-2xl bg-dotori-50 p-5 motion-safe:animate-in motion-safe:fade-in duration-300">
			...
			<ul className="mt-2 space-y-2 text-[14px] text-dotori-700">
			...
			<Link
				...
				className="mt-3 inline-flex items-center gap-1.5 py-1 text-[14px] font-semibold text-dotori-600 transition-colors hover:text-dotori-700"
			>
