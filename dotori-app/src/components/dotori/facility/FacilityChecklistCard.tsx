...
export function FacilityChecklistCard({
	...
	return (
		<section className={'glass-card rounded-2xl shadow-sm'}>
			<button
				onClick={onToggle}
			...
			>
				...
				<span
					className={cn(
						'text-body font-medium transition-transform',
				...
				<div className={'border-t border-dotori-100 p-4'}>
					{checklist ? (
						...
						<div className={'flex justify-center py-6'}>
							<div
								className={
									'h-6 w-6 animate-spin rounded-full border-2 border-dotori-300 border-t-dotori-600'
								}
							/>
						</div>
					)}
