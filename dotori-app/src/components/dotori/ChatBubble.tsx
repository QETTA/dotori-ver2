  ...
  if (role === 'user') {
    return (
      ...
      >
        ...
        >
          {children}
          <span className="mt-1 block text-right text-[12px] text-dotori-200" suppressHydrationWarning>
  ...
  return (
    ...
    >
      ...
      <div className="flex max-w-[85%] flex-col gap-2">
        ...
        <span className="px-1 text-[12px] text-dotori-400" suppressHydrationWarning>{formatRelativeTime(timestamp)}</span>
      </div>
    </div>
  )
})
