...
export function KakaoChannelButton({
  ...
  return (
    <motion.a
      ...
      className={cn('inline-flex min-h-11 items-center gap-2 rounded-full bg-[#FEE500] px-5 py-2.5 text-sm font-bold shadow-sm transition-shadow hover:shadow-md active:scale-[0.97]', DS_TEXT.primary, 'text-[#3C1E1E]', className)}
