				...
				>
					...
					>
						...
						<img
							...
							alt=""
							className={cn(
								'mx-auto mb-2.5 h-14 w-14 rounded-full border border-dotori-200/80 bg-white dark:border-dotori-700 dark:bg-dotori-900',
									...
									<motion.div {...tap.chip}>
									 ...
									 variant="ghost"
										type="button"
											...
											className={cn(
												'glass-card',
												'flex min-h-11 w-full items-center gap-2.5 rounded-xl border border-dotori-200/80 px-3 py-2.5 text-left transition-all dark:border-dotori-800/70',
										...
										>
											<span className={'grid h-8 w-8 shrink-0 place-items-center rounded-full border border-dotori-200/70 bg-white text-body shadow-sm dark:border-dotori-700 dark:bg-dotori-900 dark:shadow-none'}>
												{prompt.icon}
											</span>
