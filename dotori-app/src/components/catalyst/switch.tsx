...
const colors = {
  ...
  dotori: [
    '[--switch-bg-ring:var(--color-dotori-500)]/80 [--switch-bg:var(--color-dotori-400)] dark:[--switch-bg-ring:transparent]',
    '[--switch:white] [--switch-ring:var(--color-dotori-500)]/90 [--switch-shadow:var(--color-dotori-900)]/20',
  ],
  yellow: [
