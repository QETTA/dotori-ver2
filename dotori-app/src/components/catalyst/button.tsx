...
const styles = {
  ...
  colors: {
    ...
    dotori: [
      'text-white [--btn-hover-overlay:var(--color-white)]/10 [--btn-bg:var(--color-dotori-400)] [--btn-border:var(--color-dotori-500)]/90',
      '[--btn-icon:var(--color-dotori-200)] data-active:[--btn-icon:var(--color-dotori-100)] data-hover:[--btn-icon:var(--color-dotori-100)]',
    ],
    yellow: [
