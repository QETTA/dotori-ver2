...
/* ── Gradient Text (className utility) — max hue shift brown→gold ── */
export const gradientText =
	"bg-gradient-to-r from-dotori-700 via-dotori-400 to-amber-400 bg-clip-text text-transparent dark:from-dotori-200 dark:via-dotori-400 dark:to-amber-400";

/** Gradient text for hero — dark brown → bright gold, unmissable */
