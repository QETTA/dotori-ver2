...
/* ── Gradient Text (className utility) — visible gradient on cream bg ── */
export const gradientText =
	"bg-gradient-to-r from-dotori-800 via-dotori-500 to-amber-500 bg-clip-text text-transparent dark:from-dotori-200 dark:via-dotori-400 dark:to-amber-400";

/** Gradient text with stronger range for hero sections */
export const gradientTextHero =
	"bg-gradient-to-r from-dotori-700 via-amber-600 to-amber-400 bg-clip-text text-transparent dark:from-dotori-200 dark:via-amber-400 dark:to-amber-300";
