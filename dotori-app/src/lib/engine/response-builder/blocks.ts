...
async function buildGeneralResponse(
	...
	const content =
		aiResponse.success && aiResponse.content
			? aiResponse.content
			: "안녕하세요! 저는 토리예요. 어린이집·유치원 검색, 비교, 입소 전략까지 도와드릴 수 있어요. 무엇이 궁금하세요?";
	...
	return {
		...
		blocks: [
			{ type: "text", content },
			{
				type: "ui_block",
				title: "전체 템플릿 UI 블록",
				subtitle: "Catalyst UI 포함, Tailwind Plus 템플릿 전체 목록",
				layout: "grid",
				items: [
					{
						id: "facility_template_catalyst_ui_kit",
						title: "Catalyst UI Kit",
						description: "Headless UI 기반 앱 컴포넌트 키트",
						badge: "UI Kit",
						href: "/explore?template=catalyst-ui-kit",
						actionLabel: "열어보기",
					},
					{
						id: "facility_template_radiant",
						title: "Radiant",
						description: "제품·마케팅 랜딩 템플릿",
						badge: "템플릿",
						href: "/explore?template=tailwind-plus-radiant",
						actionLabel: "열어보기",
					},
					{
						id: "facility_template_salient",
						title: "Salient",
						description: "SaaS 마케팅 홈페이지 템플릿",
						badge: "템플릿",
						href: "/explore?template=tailwind-plus-salient",
						actionLabel: "열어보기",
					},
					{
						id: "facility_template_spotlight",
						title: "Spotlight",
						description: "문서/지식베이스 스타일 템플릿",
						badge: "템플릿",
						href: "/explore?template=tailwind-plus-spotlight",
						actionLabel: "열어보기",
					},
					{
						id: "facility_template_studio",
						title: "Studio",
						description: "포트폴리오/프로필형 템플릿",
						badge: "템플릿",
						href: "/explore?template=tailwind-plus-studio",
						actionLabel: "열어보기",
					},
					{
						id: "facility_template_commit",
						title: "Commit",
						description: "블로그/콘텐츠 중심 템플릿",
						badge: "템플릿",
						href: "/explore?template=tailwind-plus-commit",
						actionLabel: "열어보기",
					},
					{
						id: "facility_template_compass",
						title: "Compass",
						description: "학습/강의형 문서 템플릿",
						badge: "템플릿",
						href: "/explore?template=tailwind-plus-compass",
						actionLabel: "열어보기",
					},
					{
						id: "facility_template_keynote",
						title: "Keynote",
						description: "이벤트/컨퍼런스 랜딩 템플릿",
						badge: "템플릿",
						href: "/explore?template=tailwind-plus-keynote",
						actionLabel: "열어보기",
					},
					{
						id: "facility_template_pocket",
						title: "Pocket",
						description: "뉴스레터/콘텐츠 소개 템플릿",
						badge: "템플릿",
						href: "/explore?template=tailwind-plus-pocket",
						actionLabel: "열어보기",
					},
					{
						id: "facility_template_primer",
						title: "Primer",
						description: "프로덕트 시작 페이지 템플릿",
						badge: "템플릿",
						href: "/explore?template=tailwind-plus-primer",
						actionLabel: "열어보기",
					},
					{
						id: "facility_template_protocol",
						title: "Protocol",
						description: "제품 문서/가이드 템플릿",
						badge: "템플릿",
						href: "/explore?template=tailwind-plus-protocol",
						actionLabel: "열어보기",
					},
					{
						id: "facility_template_oatmeal",
						title: "Oatmeal",
						description: "브랜드 랜딩/소개형 템플릿",
						badge: "신규",
						href: "/explore?template=tailwind-plus-oatmeal",
						actionLabel: "열어보기",
					},
					{
						id: "facility_template_syntax",
						title: "Syntax",
						description: "Markdoc 기반 문서 템플릿",
						badge: "신규",
						href: "/explore?template=tailwind-plus-syntax",
						actionLabel: "열어보기",
					},
					{
						id: "facility_template_transmit",
						title: "Transmit",
						description: "오디오/피드 기반 콘텐츠 템플릿",
						badge: "신규",
						href: "/explore?template=tailwind-plus-transmit",
						actionLabel: "열어보기",
					},
				],
			},
