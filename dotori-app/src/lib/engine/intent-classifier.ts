...
const keywords: Record<ChatIntent, WeightedKeyword[]> = {
	...
	transfer: [
		...
		{ word: "다른 유치원", weight: 3 },
		{ word: "유치원 이동", weight: 3 },
		{ word: "국공립 당첨", weight: 3 },
		{ word: "국공립 대기 당첨", weight: 3 },
		{ word: "국공립 대기", weight: 2 },
		{ word: "대기 당첨", weight: 3 },
		{ word: "연락 왔", weight: 2 },
		{ word: "바꾸고", weight: 2 },
		{ word: "반편성", weight: 3 },
	...
	status: [
		...
		{ word: "TO", weight: 2 },
		{ word: "빈자리", weight: 1 },
		{ word: "유치원 TO", weight: 2 },
		{ word: "유치원 빈자리", weight: 2 },
		{ word: "현황", weight: 1 },
		{ word: "신청", weight: 1 },
		{ word: "상태", weight: 1 },
		{ word: "언제", weight: 1 },
	...
	knowledge: [
		...
		{ word: "아이사랑포털", weight: 2 },
		{ word: "유보통합", weight: 3 },
		{ word: "유치원 신청", weight: 3 },
		{ word: "누리과정", weight: 2 },
		{ word: "지원금", weight: 2 },
		{ word: "우선순위", weight: 3 },
		{ word: "가산점", weight: 3 },
...
export function classifyIntent(
	...
	if (context?.previousMessages?.length) {
		...
		if (lastAssistant?.content.includes("어린이집") || lastAssistant?.content.includes("유치원") || lastAssistant?.content.includes("시설")) {
			if (lower.includes("여기") || lower.includes("이거") || lower.includes("이 곳") || lower.includes("이 시설") || lower.includes("이 어린이집") || lower.includes("이 유치원") || lower.includes("거기")) {
				scores.explain += 2;
			}
		}
	}
