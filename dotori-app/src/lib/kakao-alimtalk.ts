...
/**
 * 알림톡 템플릿 ID 상수
 * 카카오 비즈메시지 승인 후 실제 ID로 교체 필요
 */
export const ALIMTALK_TEMPLATES = {
	/** 빈자리 알림 */
	vacancy: "DOTORI_VACANCY_001",
	/** 대기명단 변동 */
	waitlist_update: "DOTORI_WAITLIST_001",
	/** 서류 서명 요청 */
	sign_request: "DOTORI_SIGN_001",
	/** 서류 서명 완료 */
	sign_complete: "DOTORI_SIGN_002",
	/** 입소 확정 안내 */
	admission_confirm: "DOTORI_ADMIT_001",
	/** 구독 만료 예정 */
	subscription_expiry: "DOTORI_SUB_001",
} as const;
...
/**
 * 알림톡 발송 가능 여부 확인
 * Solapi 환경변수 3개가 모두 설정되어야 true
 */
export function isAlimtalkConfigured(): boolean {
	return Boolean(SOLAPI_API_KEY && SOLAPI_SECRET && KAKAO_SENDER_KEY);
}
